...
-->
   ...
   <bean id="mysqlDataSource" class="org.apache.commons.dbcp.BasicDataSource"
		destroy-method="close">
		<property name="driverClassName" value="com.mysql.jdbc.Driver" />
		<property name="url" value="jdbc:mysql://13.125.198.29:3306/marlmsone?allowMultiQueries=true" />
		<property name="username" value="root" />
		<property name="password" value="hwangkh704!" />
		<property name="validationQuery" value="select 1" />
	</bean> 
	...
	<mvc:interceptors>
		<mvc:interceptor>
			...
			<mvc:exclude-mapping path="/selectFindInfoId.do" />
			<mvc:exclude-mapping path="/selectFindInfoPw.do" />
