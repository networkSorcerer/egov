 ...
 * Generated at: 2024-07-31 07:02:25 UTC
...
return;
    ...
    try {
      ...
      out.write("\t});\r\n");
      out.write("\t$(\"#newItem\").click(function(){\r\n");
      out.write("\t\tnewItem();\r\n");
      ...
      out.write("    });\r\n");
      out.write("    $(\"#insertNewItem\").click(function(){\r\n");
      out.write("    \tInsertNewItem();\r\n");
      out.write("    } )\r\n");
      out.write("})\r\n");
      out.write("\r\n");
      ...
      out.write("\tconsole.log(\"확인2\");\r\n");
      out.write("\t$(\"#layerNewItem\").show();\r\n");
      out.write("\t$(\"#fileInput\").empty();\r\n");
      out.write("\t$(\"#layer30\").hide();\r\n");
      out.write("\t$(\"#layer20\").hide();\r\n");
      out.write("\t$(\"#main_item\").hide();\r\n");
      out.write("}\r\n");
      out.write("function InsertNewItem() {\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\t\r\n");
      out.write("\t})\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function estm_detail (){\r\n");
      out.write("\t$.ajsx({\r\n");
      out.write("\t\turl:\"\",\r\n");
      out.write("\t\t\r\n");
      out.write("\t})\r\n");
      ...
      out.write("            var fileExtension = fileName.split('.').pop().toLowerCase();  // 파일 확장자 추출\r\n");
      out.write("            \r\n");
      out.write("            var imgPath = \"\";\r\n");
      out.write("            var previewHtml = \"\";\r\n");
      out.write("            \r\n");
      out.write("            // 지원하는 이미지 형식인지 확인\r\n");
      out.write("            if (fileExtension === \"jpg\" || fileExtension === \"gif\" || fileExtension === \"png\") {\r\n");
      out.write("                imgPath = window.URL.createObjectURL(file);\r\n");
      out.write("                previewHtml = \"<img src='\" + imgPath + \"' id='imgFile' style='width: 100px; height: 100px;' />\";\r\n");
      out.write("                \r\n");
      out.write("                // 이전 미리보기 이미지 URL 해제\r\n");
      out.write("                if ($(\"#imgFile\").length) {\r\n");
      out.write("                    URL.revokeObjectURL($(\"#imgFile\").attr('src'));\r\n");
      out.write("                }\r\n");
      out.write("            } else {\r\n");
      out.write("                previewHtml = \"<p>지원하지 않는 파일 형식입니다.</p>\";\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // 미리보기 HTML 업데이트\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tvar getForm = document.getElementById(\"layerNewItem\");\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function item_code () {\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl:\"/item/item_code.do\",\r\n");
      out.write("\t\ttype: \"post\",\r\n");
      out.write("\t\tdataType : \"json\",\r\n");
      out.write("\t\tsuccess : function(response) {\r\n");
      out.write("\t\t\tvar dataList = response.item_code;\r\n");
      out.write("\t\t\tvar html =\"\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tdataList.forEach(function(item){\r\n");
      out.write("\t\t\t\thtml+=\"<option>\"+item.item_code+\"(\"+item.estm_num+\")\"+\"</option>\";\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#item_code1\").html(html);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t})\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      ...
      out.write("            <button class=\"btn btn-success\" id=\"newItem\" >아이템 신규등록</button>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("<form id=\"layerNewItem\">\r\n");
      out.write("\t<div >\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<h1>신규 item 등록</h1>\r\n");
      out.write("\t\t\t<a href=\"javascript:itemOption();\" class=\"btn btn-success\">옵션으로 보기</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<table class=\"col\">\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<select id=\"item_code1\"  class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 아마도 여기에 나오는게 아닌가 싶다 ㄷㄷ  -->\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>상품명</td>\r\n");
      out.write("\t\t\t\t\t<td><input  type='text' id=\"newItemName\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>제조사</td>\r\n");
      out.write("\t\t\t\t\t<td><input  type='text' id=\"newManufac\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>가격</td>\r\n");
      out.write("\t\t\t\t\t<td><input  type='text' id=\"newProvideValue\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>상품 이미지</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"file\" name=\"fileInput\" id=\"fileInput\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t<td >\r\n");
      ...
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<button id=\"insertNewItem\" class=\"btn btn-success\">등록</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("</form>\t\r\n");
      out.write("\t\r\n");
      out.write("</body>\r\n");
