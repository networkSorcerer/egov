 ...
 * Generated at: 2024-07-22 00:35:35 UTC
...
return;
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("//row 클릭 시 배송지시서 상세보기 모달이 나오도록 설정\r\n");
      out.write("/*\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("    $(\".clickable-row\").click(function(){\r\n");
      out.write("        var rowId = $(this).attr('id');\r\n");
      out.write("        var orderNumber = $(this).find('.order-number').text();\r\n");
      out.write("        var orderDate = $(this).find('.order-date').text();\r\n");
      out.write("        var companyName = $(this).find('.company-name').text();\r\n");
      out.write("        var orderQuantity = $(this).find('.order-quantity').text();\r\n");
      out.write("\r\n");
      out.write("        $('#modalOrderNumber').val(orderNumber);\r\n");
      out.write("        $('#modalOrderDate').val(orderDate);\r\n");
      out.write("        $('#modalCompanyName').val(companyName);\r\n");
      out.write("        $('#modalOrderQuantity').val(orderQuantity);\r\n");
      out.write("\r\n");
      out.write("        $(\"#deliveryDetailPop\").modal('show');\r\n");
      out.write("    });\r\n");
      out.write("    // 닫기 버튼 기능\r\n");
      out.write("    $(\"#btnClose\").click(function(e){\r\n");
      out.write("        e.preventDefault();\r\n");
      out.write("        $(\"#deliveryDetailPop\").modal('hide');\r\n");
      out.write("    });\r\n");
      out.write("});\r\n");
      out.write("*/\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t$(\"#directionDeliveryList\").empty().append(res);\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tcallAjax(\"/direction/directionDeliveryList.do\", \"post\", \"text\", false, param, callBackFunction);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t</p> \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<!-- 여기를 없앨까?? 배송지시서 클릭시 모달 나오도록 \r\n");
      ...
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">배송시작일</th>\r\n");
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">배송담당자 </th>\r\n");
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">출발지 </th>\r\n");
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">목적지 </th>\r\n");
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">배송개수</th>\r\n");
      out.write("\t\t\t\t\t\t\t              <th scope=\"col\">배송상태</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody id=\"directionDeliveryList\" class=\"clickable-row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 페이징 처리  -->\r\n");
      ...
      out.write("                                <td><input type=\"text\" class=\"inputTxt p100\" id=\"modalOrderNumber\" readonly=\"readonly\"/></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <th scope=\"row\">주문일자</th>\r\n");
      out.write("                                <td><input type=\"text\" class=\"inputTxt p100\" id=\"modalOrderDate\" readonly=\"readonly\"/></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <th scope=\"row\">고객기업명</th>\r\n");
      out.write("                                <td><input type=\"text\" class=\"inputTxt p100\" id=\"modalCompanyName\" readonly=\"readonly\"/></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <th scope=\"row\">주문개수</th>\r\n");
      out.write("                                <td><input type=\"text\" class=\"inputTxt p100\" id=\"modalOrderQuantity\" readonly=\"readonly\"/></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                        </tbody>\r\n");
      out.write("                    </table>\r\n");
