 ...
 * Generated at: 2024-07-11 01:22:54 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t// Add button event registrations here if needed\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\tvar paginationHtml = getPaginationHtml(cpage, $('#totcnt').val(), pageSize, pageBlockPage, \"noticeSearch\");\r\n");
      out.write("\t\t\t$(\"#pagingNavi\").empty().append(paginationHtml);\r\n");
      out.write("\t\t\t$(\"#currentPage\").val(cpage);\r\n");
      out.write("\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\tcallAjax(\"/system/nList.do\", \"post\", \"text\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t[\"noticeTitle\", \"제목을 입력해주세요\"],\r\n");
      out.write("\t\t\t[\"noticeContent\", \"내용을 입력해주세요\"]\r\n");
      out.write("\t\t]);\r\n");
      out.write("\t\tif (!chk) {\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar callBackFuntion = function(data) {\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\tcallAjax(\"/system/nDetail.do\", \"post\", \"json\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\tcallAjax(\"/system/nSave.do\", \"post\", \"json\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\ttitle:$(\"#noticeTitle\").val(),\r\n");
      out.write("\t\t\t\tcontent:$(\"#noticeContent\").val(),\r\n");
      out.write("\t\t\t\tnotiecSeq:$(\"#noticeSeq\").val()\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar callBackFunction = function(response) {\r\n");
      out.write("\t\t\tif(response.result == \"success\"){\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/system/nUpdate.do\", \"post\", \"json\", false, param, callBackFunction);\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/system/nDelete.do\", \"post\", \"json\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t//------------------------------------------파아아아아아아아아이이이이이이일기이이이이이이이느으으으으으으으으으으응(파일기능)---------------------------//\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\tvar fileInfoSplit = fielInfo.split(\".\");\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tcalAjaxFileUploadSetFormData(\"/system/noticeSaveFile.do\", \"post\", \"json\", false, fileData, callBackFunction);\r\n");
      out.write("\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tvar callBackFunction = function(data){\r\n");
      out.write("\t\t\tif(data.reuslt == \"success\"){\r\n");
