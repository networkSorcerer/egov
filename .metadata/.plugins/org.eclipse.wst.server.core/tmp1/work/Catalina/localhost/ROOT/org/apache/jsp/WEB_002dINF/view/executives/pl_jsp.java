 ...
 * Generated at: 2024-07-17 01:36:11 UTC
...
public final class pl_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\tvar title = [ 'Month', '수주액', '발주액' ];\r\n");
      out.write("\t\t\t\tvar data = [];\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t// 데이터 포맷팅\r\n");
      out.write("\t\t\t\tdata.push(title); // 제목 추가\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t// 서버에서 받아온 데이터 포맷팅\r\n");
      out.write("\t\t\t\tfor (var i = 0; i < res.length; i++) {\r\n");
      out.write("\t\t\t\t\tvar rowData = [ res[i].month, // 월\r\n");
      out.write("\t\t\t\t\tres[i].total_obtain || 0, // 수주액 (없을 경우 기본값 0)\r\n");
      out.write("\t\t\t\t\tres[i].total_order || 0 // 발주액 (없을 경우 기본값 0)\r\n");
      out.write("\t\t\t\t\t];\r\n");
      out.write("\t\t\t\t\tdata.push(rowData);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar dataTable = google.visualization.arrayToDataTable(data);\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar options = {\r\n");
      out.write("\t\t\t\t\ttitle : '수주 & 발주 금액',\r\n");
      out.write("\t\t\t\t\tcurveType : 'function', // 선 그래프로 설정\r\n");
      out.write("\t\t\t\t\tlegend : {\r\n");
      out.write("\t\t\t\t\t\tposition : 'bottom'\r\n");
      out.write("\t\t\t\t\t}, // 범례 위치 설정\r\n");
      out.write("\t\t\t\t\thAxis : {\r\n");
      out.write("\t\t\t\t\t\ttitle : '날짜' // x 축 제목\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\tvAxis : {\r\n");
      out.write("\t\t\t\t\t\ttitle : '금액' // y 축 제목\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t// 그래프를 그릴 요소 선택\r\n");
      out.write("\t\t\t\tvar chart = new google.visualization.LineChart(document\r\n");
      out.write("\t\t\t\t\t\t.getElementById('curve_chart'));\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t// 그래프 그리기\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t// Ajax 호출\r\n");
      out.write("\t\tcallAjax(\"/executives/chart.do\", \"post\", \"json\", false, param,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"btn_nav bold\">현황</a> <span class=\"btn_nav bold\">손익</span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"curve_chart\" style=\"width: 1030px; height: 700px\"></div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<div id=\"approvalModal\" class=\"layerPop layerType2\"\r\n");
      out.write("\t\tstyle=\"width: 122px;\"></div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
