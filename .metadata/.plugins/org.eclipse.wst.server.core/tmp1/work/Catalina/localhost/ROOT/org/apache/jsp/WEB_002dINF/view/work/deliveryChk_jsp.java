...
public final class deliveryChk_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deliveryList(type){\r\n");
      out.write("\t\tvar param = {\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t\t$(\"#deliveryList\").empty().append(res);\r\n");
      out.write("\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tcallAjax(\"/work/deliveryList.do\", \"post\", \"text\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction deliveryModal(seq){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\t\tdelivery_num : seq\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t\tvar callBackFunction = function(res) {\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t$(\"#modalItem_name\").val(res[0].item_name)\r\n");
      out.write("\t\t\t$(\"#modalObtain_count\").val(res[0].obtain_count)\r\n");
      out.write("\t\t\t$(\"#modalDelivery_num\").val(res[0].delivery_num)\r\n");
      out.write("\t\t\t$(\"#modalDelivery_state\").val(res[0].delivery_state)\r\n");
      out.write("\t\t\tif(res[0].delivery_state == '배송완료'){\r\n");
      out.write("\t\t\t\t$(\"#deliveryY\").css({\r\n");
      out.write("\t\t\t\t\t'color' : '#bbc2cd',\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//$(\"#deliveryList\").empty().append(res);\r\n");
      out.write("\t\t\tgfModalPop(\"#deliveryModal\");\r\n");
      out.write("\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tcallAjax(\"/work/deliveryDetail.do\", \"post\", \"json\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction clickEvent(){\r\n");
      out.write("\t\t$(\"#deliveryY\").click(function(e){\r\n");
      out.write("\t\t\tif($(\"#modalDelivery_state\").val() == '배송중'){\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tdeleveryDone($(\"#modalDelivery_num\").val()) \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\"#deliveryN\").click(function(e){\r\n");
      out.write("\t\t\tgfCloseModal(\"#deliveryModal\");\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction radioChange(){\r\n");
      out.write("\t\t $('input[type=radio][name=\"deliveryRadio\"]').change(function() {\r\n");
      out.write("\t\t\t deliveryList($(this).val())\r\n");
      out.write("\t\t });\r\n");
      out.write("\t\t $('input[type=radio][name=\"deliveryRadio\"]').change(function() {\r\n");
      out.write("\t\t\t deliveryList($(this).val())\r\n");
      out.write("\t\t });\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction deleveryDone(num){\r\n");
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\t\tdelivery_num : num\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t\tvar callBackFunction = function(res) {\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tcallAjax(\"/work/deleveryDone.do\", \"post\", \"text\", false, param, callBackFunction);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</script> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"btn_nav bold\">담당업무</a> <span class=\"btn_nav bold\">배송처리</span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">목적지</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">배송결과</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">상세보기</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"deliveryList\"></tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div id=\"deliveryModal\" class=\"layerPop layerType2\" style=\"width: 122px;\">\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<div class=\"textCenter\" style=\"color: green;\">상세보기</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<div>제품명</div>\r\n");
      out.write("\t\t\t\t\t<input id=\"modalItem_name\" class=\"modalInput\" disabled>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<div>수량</div>\r\n");
      out.write("\t\t\t\t\t<input id=\"modalObtain_count\" class=\"modalInput\" disabled>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"modalDelivery_num\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"modalDelivery_state\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<div class=\"left\" id=\"deliveryY\">배송완료</div>\r\n");
      out.write("\t\t\t\t<div class=\"right\" id=\"deliveryN\">취소</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
      out.write("\t</div>\r\n");
