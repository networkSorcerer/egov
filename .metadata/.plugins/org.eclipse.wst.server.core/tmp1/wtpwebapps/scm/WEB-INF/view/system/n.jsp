...
<script>
	...
	function registerBtnEvent() {
		// Add button event registrations here if needed
	}
	...
	function noticeSearch(cpage) {
		...
		var callBackFunction = function(response) {
			...
			var paginationHtml = getPaginationHtml(cpage, $('#totcnt').val(), pageSize, pageBlockPage, "noticeSearch");
			$("#pagingNavi").empty().append(paginationHtml);
			$("#currentPage").val(cpage);
		};

		callAjax("/system/nList.do", "post", "text", false, param, callBackFunction);
	}
	...
	function noticeDetailModal(seq) {
		...
		var callBackFuntion = function(data) {
			...
			callAjax("/system/nDetail.do", "post", "json", false, param, callBackFunction);
	}
	...
	function saveNotice() {
		...
		callAjax("/system/nSave.do", "post", "json", false, param, callBackFunction);
	}
	...
	function updateNotice(){
		...
		callAjax("/system/nUpdate.do", "post", "json", false, param, callBackFunction);
	...
	function deleteNotice() {
		...
		callAjax("/system/nDelete.do", "post", "json", false, param, callBackFunction);
	}
	
	
	
	//------------------------------------------파아아아아아아아아이이이이이이일기이이이이이이이느으으으으으으으으으으응(파일기능)---------------------------//
	...
	function filePreview() {
		$("#fileInput").change(function(e){
			...
			if($(this)[0].files[0]){
				...
				var fileInfoSplit = fielInfo.split(".");
	...
	calAjaxFileUploadSetFormData("/system/noticeSaveFile.do", "post", "json", false, fileData, callBackFunction);
