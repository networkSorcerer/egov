 ...
 * Generated at: 2024-06-17 02:13:30 UTC
...
public final class lectureRoom_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<title>시설 관리 : 강의실</title>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t// 강의실 명 검색\r\n");
      out.write("\tfunction lectureRoomSearch(cpage){\r\n");
      out.write("\t\tcpage = cpage || 1;\t// undefined 일 때 1값 나오게 설정\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// key : value 의 JSON 형태로 데이터 넘기기\r\n");
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\tsearchRoomName : $(\"#searchRoomName\").val(),\r\n");
      ...
      out.write("\t\t\t$(\"#listLectureBody\").empty().append(response);\r\n");
      out.write("\t\t\tconsole.log($(\"#listcnt\").val());\r\n");
      out.write("\t\t\t// common.js 의 페이징 getPaginationHtml() 함수 사용\r\n");
      out.write("\t\t\tvar paginationHtml = getPaginationHtml(cpage, $(\"#listcnt\").val(), pagesize, pageblocksize, 'lectureRoomSearch'); \r\n");
      out.write("\t\t\tconsole.log(\"paginationHtml : \" + paginationHtml);\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#lectureRoomPagination\").empty().append(paginationHtml); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 장비 관리 쪽 정보 초기화 하고 숨기기\r\n");
      out.write("\t\t\t$(\"#equcpage\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#equ_id\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#equ\").hide();\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\tcallAjax(\"/adm/lectureRoomList.do\", \"post\", \"text\", false, param, listCallback);\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t// 값 초기화 함수\r\n");
      out.write("\t// data 여부를 판단해 등록과 수정으로 나누어 초기화 \r\n");
      out.write("\tfunction init(data){\r\n");
      out.write("\t\tif(data!=null){\r\n");
      out.write("\t\t\t$(\"#lecrm_id\").val(data.lecrm_id);\r\n");
      out.write("\t\t\t$(\"#lecrm_name\").val(data.lecrm_name);\r\n");
      out.write("\t\t\t$(\"#lecrm_size\").val(data.lecrm_size);\r\n");
      out.write("\t\t\t$(\"#lecrm_snum\").val(data.lecrm_snum);\r\n");
      out.write("\t\t\t$(\"#lecrm_note\").val(data.lecrm_note);\r\n");
      out.write("\t\t\t$(\"#action\").val(\"U\");\t// 수정일 때 U 값으로 초기화\r\n");
      out.write("\t\t\t$(\"#btnDelete\").show();\t// 신규 등록일 때 삭제 버튼을 드러내기\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$(\"#lecrm_id\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#lecrm_name\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#lecrm_size\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#lecrm_snum\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#lecrm_note\").val(\"\");\r\n");
      ...
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\t\tlecrm_name : $(\"#lecrm_name\").val()\r\n");
      out.write("\t\t\t\t, lecrm_size : $(\"#lecrm_size\").val()\r\n");
      out.write("\t\t\t\t, lecrm_snum : $(\"#lecrm_snum\").val()\r\n");
      out.write("\t\t\t\t, lecrm_note : $(\"#lecrm_note\").val()\r\n");
      ...
      out.write("\t\t\t\t\tlectureRoomSearch();\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\tlectureRoomSearch($(\"#cpage\").val());\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/adm/lectureRoomSave.do\", \"post\", \"json\", false, param, savecallback);\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t// 강의실 수정 - 상세\r\n");
      out.write("\tfunction modify(lecrm_id){\r\n");
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\t\tlecrm_id : lecrm_id\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar delcallback = function(response){\r\n");
      out.write("\t\t\tconsole.log(JSON.stringify(response));\r\n");
      out.write("\t\t\t// 가져온 값 넣어서 수정 창 뜰 수 있게\r\n");
      out.write("\t\t\tinit(response.selinfo);\t\r\n");
      out.write("\t\t\tgfModalPop(\"#layer1\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/adm/lectureRoomDtl.do\", \"post\", \"json\", false, param, delcallback);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("\t// 강의실 삭제\r\n");
      out.write("\tfunction Delete(lecrm_id){\r\n");
      out.write("\t\t$(\"#action\").val(\"D\");\r\n");
      out.write("\t\tSave();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t/** 강의실 등록/수정 저장 validation */\r\n");
      out.write("\tfunction fValidate() {\r\n");
      out.write("\t\tvar chk = checkNotEmpty(\r\n");
      out.write("\t\t\t\t[\r\n");
      out.write("\t\t\t\t\t\t[ \"lecrm_name\", \"강의실 명을 입력해 주세요.\" ]\r\n");
      out.write("\t\t\t\t\t,\t[ \"lecrm_size\", \"강의실 크기를 입력해 주세요\" ]\r\n");
      out.write("\t\t\t\t\t,\t[ \"lecrm_snum\", \"강의실 자리수를 입력해 주세요\" ]\r\n");
      out.write("\t\t\t\t]\r\n");
      out.write("\t\t);\r\n");
      out.write("\r\n");
      out.write("\t\tif (!chk) {\r\n");
      ...
      out.write("\t//////////////////////////////////////////////////////////////////////////////////////////////////////\r\n");
      out.write("\t\r\n");
      out.write("\t// 강의실 장비 리스트(아이디)\r\n");
      out.write("\tfunction equSearchList(lecrm_id) {\r\n");
      out.write("\t\t$(\"#lecrm_id\").val(lecrm_id);\r\n");
      out.write("\t\tequSearch();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// 강의실 장비 리스트(페이지)\r\n");
      out.write("\tfunction equSearch(cpage){\r\n");
      out.write("\t\t$(\"#equ\").show();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcpage = cpage || 1;\t// undefined 일 때 1값 나오게 설정\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tvar listCallback = function(response){\r\n");
      out.write("\t\t\tconsole.log(response);\r\n");
      out.write("\t\t\t$(\".divEquList\").show();\r\n");
      out.write("\t\t\t$(\"#equPagination\").show();\r\n");
      out.write("\t\t\t$(\"#listEquBody\").empty().append(response);\r\n");
      out.write("\t\t\tconsole.log(\"listcnt : \" + $(\"#listcnt\").val());\r\n");
      out.write("\t\t\t// common.js 의 페이징 getPaginationHtml() 함수 사용\r\n");
      out.write("\t\t\t// equSearch 는 어떤 함수를 사용할 지에 대한 부분? 명시하는 듯\r\n");
      out.write("\t\t\tvar paginationHtml = getPaginationHtml(cpage, $(\"#equlistcnt\").val(), pagesize, pageblocksize, 'equSearch'); \r\n");
      out.write("\t\t\tconsole.log(\"paginationHtml : \" + paginationHtml);\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#equPagination\").empty().append(paginationHtml); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 보고있는 페이지 유지를 하기 위함\r\n");
      out.write("\t\t\t$(\"#equcpage\").val(cpage);\r\n");
      out.write("\t\t};\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// callAjax(url, method, dataType, async, param, callback)\r\n");
      out.write("\t\t\t// async : false , sync : true -- 비동기(요청하고 다른 동작 가능) / 동기\r\n");
      out.write("\t\tcallAjax(\"/adm/equList.do\", \"post\", \"text\", false, param, listCallback);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// data 여부를 판단해 등록과 수정으로 나누어 초기화 \r\n");
      out.write("\tfunction initEqu(data){\r\n");
      out.write("\t\tif(data!=null){\r\n");
      ...
      out.write("\t\t\t$(\"#action\").val(\"U\");\t// 수정일 때 U 값으로 초기화\r\n");
      out.write("\t\t\t$(\"#btnDeleteEqu\").show();\t// 신규 등록일 때 삭제 버튼을 드러내기\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$(\"#equ_id\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#equ_name\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#equ_num\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#equ_note\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#action\").val(\"I\");\t// 신규 등록일 때 I 값으로 초기화\r\n");
      out.write("\t\t\t$(\"#btnDeleteEqu\").hide();\t// 신규 등록일 때 삭제 버튼을 숨기기\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// 등록 모달 팝업 하는 함수\r\n");
      out.write("\tfunction newRegEqu(){\r\n");
      out.write("\t\tinitEqu();\r\n");
      out.write("\t\tconsole.log(\"action : \" + $(\"#action\").val());\r\n");
      out.write("\t\tgfModalPop(\"#layer2\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// 장비 관리 Validation check\r\n");
      out.write("\tfunction eValidate() {\r\n");
      out.write("\t\tvar chk = checkNotEmpty(\r\n");
      out.write("\t\t\t\t[\r\n");
      ...
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t// 장비 관리 등록/수정 하는 함수\r\n");
      out.write("\tfunction SaveEqu(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(!eValidate()){\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar param = {\r\n");
      ...
      out.write("\t\t\t\t\tequSearch();\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\tequSearch($(\"#equcpage\").val());\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar dtlCallback = function(response){\r\n");
      out.write("\t\t\tconsole.log(JSON.stringify(response));\r\n");
      out.write("\t\t\tinitEqu(response.selinfo);\t\r\n");
      out.write("\t\t\tgfModalPop(\"#layer2\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/adm/equDtl.do\", \"post\", \"json\", false, param, dtlCallback);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t// 장비 삭제\r\n");
      out.write("\tfunction DeleteEqu(){\r\n");
      out.write("\t\t$(\"#action\").val(\"D\");\r\n");
      out.write("\t\tSaveEqu();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("\t/** 강의실 이름 중복 체크 */\r\n");
      out.write("\tfunction nameCheck(){\r\n");
      out.write("\t\tvar lecrm_name = $(\"#lecrm_name\").val().trim();\r\n");
      out.write("\t\t$(\"#lecrm_name\").val(lecrm_name);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar param = {\r\n");
      out.write("\t\t\tlecrm_id : $(\"#lecrm_id\").val(),\r\n");
      out.write("\t\t\tlecrm_name : lecrm_name,\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar savecallback = function(response){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(response.result===\"N\"){\r\n");
      out.write("\t\t\t\talert(response.resultmsg);\r\n");
      out.write("\t\t\t\t$(\"#lecrm_name\").focus();\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tcallAjax(\"/adm/lectureRoomNameCheck.do\", \"post\", \"json\", false, param, savecallback);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t -->\r\n");
      out.write("\t <input type=\"hidden\" id=\"lecrm_id\" name=\"lecrm_id\" value=\"\"/>\r\n");
      ...
      out.write("\t <input type=\"hidden\" id=\"equcpage\" name=\"equcpage\" value=\"\"/>\r\n");
      out.write("\t\r\n");
      out.write("\t<!-- 모달 배경 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tclass=\"btn_nav bold\">시설 관리</span> <span class=\"btn_nav bold\"> 강의실\r\n");
      out.write("\t\t\t\t\t\t\t\t</span> <a href=\"\" class=\"btn_set refresh\">새로고침</a>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<p class=\"conTitle\">\r\n");
      out.write("\t\t                     <span>강의실</span> <span class=\"fr\">\r\n");
      out.write("\r\n");
      out.write("\t\t                     <span style=\"font-size: 15px; font-weight: bold;\">강의실 명 </span>\r\n");
      out.write("\t\t                     <input type=\"text\" id=\"searchRoomName\" name=\"searchRoomName\"  \r\n");
      ...
      out.write("\t\t                       <a class=\"btnType blue\" href=\"javascript:newReg();\" name=\"newReg\" id=\"newReg\"><span>강의실 신규등록</span></a>\r\n");
      out.write("\t\t                     </span>\r\n");
      out.write("                  \t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">강의실 크기</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">강의실 자리수</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody id=\"listLectureBody\"></tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"paging_area\"  id=\"lectureRoomPagination\"  style=\"margin-bottom: 50px;\"> </div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div id=\"equ\">\r\n");
      out.write("\t\t\t\t\t\t\t<p class=\"conTitle\">\r\n");
      out.write("\t\t\t                     <span>장비 목록</span> <span class=\"fr\">\r\n");
      out.write("\t\t\t                       <a class=\"btnType blue\" href=\"javascript:newRegEqu();\" name=\"newRegEqu\" id=\"newRegEqu\"><span>장비 신규등록</span></a>\r\n");
      out.write("\t\t\t                     </span>\r\n");
      out.write("\t                  \t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t<dl>\r\n");
      out.write("\t\t\t<dt>\r\n");
      out.write("\t\t\t\t<strong>강의실 등록</strong>\r\n");
      out.write("\t\t\t</dt>\r\n");
      ...
      out.write("\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"row\">강의실 명 <span class=\"font_red\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=3>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"inputTxt p100\" name=\"lecrm_name\" id=\"lecrm_name\" \r\n");
      out.write("\t\t\t\t\t\t\t\tplaceholder=\"강의실 명 앞,뒤로 공백 문자 입력 불가\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"row\">강의실 크기 <span class=\"font_red\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" class=\"inputTxt p100\" name=\"lecrm_size\" id=\"lecrm_size\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"row\">강의실 자리수 <span class=\"font_red\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\"  class=\"inputTxt p100\" name=\"lecrm_snum\" id=\"lecrm_snum\" \r\n");
      out.write("\t\t\t\t\t\t\t\toninput=\"javascript:formatNumber('lecrm_snum');\"\r\n");
      out.write("\t\t\t\t\t\t\t\tplaceholder=\"숫자 입력\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"row\">비고</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=3><input type=\"text\" class=\"inputTxt p100\" name=\"lecrm_note\" id=\"lecrm_note\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" class=\"inputTxt p100\" name=\"equ_name\" id=\"equ_name\" /></td>\r\n");
